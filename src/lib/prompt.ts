...
const FORMAT_JSON = "IMPORTANTE: - La respuesta estara en español de España. - El JSON debe estar codificado en UTF-8 y minificado. - Nunca devolveras mas texto que el JSON. - Utiliza exclusivamente gr, ml o und como unidades de medida. - Para la propiedad amount, utiliza decimales en lugar de fracciones. - El JSON debe seguir estrictamente la siguiente estructura de ejemplo:";
