...
<Dialog bind:open>
	<article
		class="mx-auto flex size-full max-w-4xl flex-col items-start gap-10 overflow-y-auto overflow-x-hidden overscroll-contain px-4 py-16 lg:p-16"
	>
		...
		<footer class="flex flex-col gap-4">
			...
			{:else}
				<Button class="px-6 py-2" click={generateRecipe}>Generar receta</Button>
			{/if}
		</footer>
	</article>
</Dialog>
